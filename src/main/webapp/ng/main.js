...
var GameplayComponent = /** @class */ (function () {
    ...
    GameplayComponent.prototype.ngOnInit = function () {
        var _this = this;
        rxjs_observable_IntervalObservable__WEBPACK_IMPORTED_MODULE_3__["IntervalObservable"].create(1000).takeWhile(function () { return _this.alive && _this.status.status !== 'closed'; }).subscribe(function () {
